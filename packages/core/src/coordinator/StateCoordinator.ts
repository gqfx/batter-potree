...
export class StateCoordinator {
   ...
   */
  constructor(
    private readonly configStore: StoreApi<ConfigStore>,
   ...
   * @private
   */
  private syncSources(sources: Readonly<Record<string, SourceConfig>>): void {
   ...
   * @private
   */
  private syncCamera(camera: CameraConfig): void {
    // 同步相机位置
